    ...
    <div class="container">
        ...
        <ul class="contact-info__wrapper">
            <li>
                ...
                <h4 class="contact-info__text"><a href="tel:+03379609224">+033 79609224</a><br><a href="tel:++919007607002">+91 90076 07002</a></h4>
            </li>
            <li>
                <div class="contact-info__icon"><span class="icon-Email"></span></div>
                <p class="contact-info__title">Send Email</p>
                <h4 class="contact-info__text"><a href="mailto:support@wbjrsfoundation.org">support@wbjrsfoundation.org</a></h4>
            </li>
            <li>
                <div class="contact-info__icon"><span class="icon-Location"></span></div>
                <p class="contact-info__title">Visit Anytime</p>
                <h4 class="contact-info__text">Puspa Apartment 2, Chakraborty Para, Nona Chandanpukur, Barrackpore, Kolkata - 122</h4>
            </li>
        </ul>
        <br>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3678.953631603578!2d88.37455198885496!3d22.767102!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f89ba161e45df1%3A0xdda6d7a06ae1e780!2sWBJRS%20Academic%20Foundation!5e0!3m2!1sen!2sin!4v1715263728179!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
