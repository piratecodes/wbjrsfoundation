                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if(!empty($value['course'])){
                                                    $arr=explode('~', $value['course']);

                                                    foreach($arr as $k1 => $v1){
                                                        if(!empty($v1)){
                                                            $course=$this->Cms_model->course($v1);
                                            ...
                                            <td>
                                                <?php if ($value['status'] == 'Pending') { ?>
                                                    <a href="<?php echo base_url($this->setting['cms'].'request_course_enquire_mark/'.$id); ?>" class="btn btn-xs btn-danger" > Read </a>
                                                <?php } ?>

                                                <a href="<?php echo base_url($this->setting['cms'].'request_course_enquire_delete/'.$id); ?>" class="btn btn-sm btn-danger" title="Delete" onclick="return confirm('Are you sure to delete it?');" > <i class="fa fa-trash"></i> Delete </a>
                                            </td>                                           
                                            <!-- <td > 
