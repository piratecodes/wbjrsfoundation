...
function ClippingText($x, $y, $txt, $outline=false)
...

	    {
...

	        {
	            ...
	            elseif($this->ALIGN=='center') {
                    ...
                    $this->Cell(0,8,$e,0,1,'C');
                }

	            else {

	                $this->Write(7,stripslashes($e), 'FJ');
	            }
	...
	function WriteHtmlLeftCell($cellWidth, $html){        
	    $rm = $this->rMargin;
	    $this->SetLeftMargin($this->w - $this->GetX() - $cellWidth);
	    $this->WriteHtml($html);
	    $this->SetLeftMargin($rm);
	}
...

	{
		...
		foreach($header as $col)
			...
			$this->Cell($this->GetStringWidth($col)+5,6,$col,1);
...

		{
			...
			foreach($row as $col)
				...
				// $cellWidth = $this->GetStringWidth($string);

				// $this->Cell($cellWidth + 5, 6, $string, 1);
	...
	function FancyTable($header, $data, $w, $f, $d)
...

	{
	    ...
	    if($this->GetY()+$h+5>$this->PageBreakTrigger)
	    	...
	    	//$this->Image('assets/all/letter_head.jpg', 0, 0,210,297);
	...
	function AddPage1($orientation='', $size='', $rotation=0)
