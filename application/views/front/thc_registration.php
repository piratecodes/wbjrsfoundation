...
<section class="page-header @@extraClassName" data-jarallax data-speed="0.3" data-imgPosition="50% -100%">
    ...
    <div class="container text-center">
        <h2 class="page-header__title">Talent Hunt Registration </h2><!-- /.page-title -->
        <ul class="page-header__breadcrumb list-unstyled">
            <li><a href="<?php echo base_url()?>">Home</a></li>
            <li><span>Talent Hunt Registration </span></li>
...
<section class="about-three">
            <div class="container">
                <div class="row">
                    <div class="col-xl-16 wow fadeInLeft" data-wow-delay="100ms">
                        <div class="about-three__content"><!-- about content start-->
                            <div class="section-title">
                                
                                
        <!----- GOOGLE FORM EMBEDDED START --->
     
      
      <center>
      
    <iframe align=center bgcolor=beige src="https://docs.google.com/forms/d/e/1FAIpQLScx0cjmB9ejmAdjOKGCG_igpCD1AIFGLfCFnBd289EOGORjzg/viewform?embedded=true" width="700" height="1431" frameborder="3" bordercolor=orange marginheight="0" marginwidth="0">Loading...</iframe>
       
     </center>
        
         
        <!----- GOOGLE FORM EMBEDDED END --->
                               ...
                               <!-- <h2 class="section-title__title">Talent Hunt Registration </h2>
                            </div><!-- section-title -->
                                      ...
                                      <!---  <div class="about-three__thumb__shape-three"><span></span><span></span><span></span><span></span><span></span></div><!-- /.about-shape-three -->
                                            <!---<div class="about-three__thumb__shape-four"><img src="<?php echo base_url()?>assets/front/images/shapes/about-3-shape-1.png" alt="eduact" /></div><!-- /.about-shape-four -->
                                               <!-- <div class="about-three__thumb__shape-five"><span></span><span></span><span></span><span></span><span></span></div><!-- /.about-shape-five -->
                                                  ...
                                                  <div align=center><img height=50 width=200 src="<?php echo base_url()?>assets/logo/logo_sm11.png"></div>
