                                ...
                                <div class="row">
                                    <div class="col-md-12">                      
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name" placeholder="Page Name" value="<?php if (isset($this->data['details']) && !empty($this->data['details']['name'])) { echo $this->data['details']['name']; } ?>" readonly="" >
                                        </div>
                                    </div>
                                </div>
