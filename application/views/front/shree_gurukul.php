...
<section class="page-header page-header--bg-two" data-jarallax data-speed="0.3" data-imgPosition="50% -100%">
    ...
    <div class="container text-center">
        <h2 class="page-header__title">Academic Global Partners</h2><!-- /.page-title -->
        <ul class="page-header__breadcrumb list-unstyled">
            <li><a href="index-2.html">Home</a></li>
            <li><span>Academic Global Partners</span></li>
...
<!-- Team Start -->
<section class="team-one" style="background-image: url(<?php echo base_url()?>assets/front/images/shapes/team-bg-1.png);">
    <div class="container">
        <div class="section-title text-center wow fadeInUp" data-wow-delay="100ms">
            <h5 class="section-title__tagline">
               Academic Global Partners
            ...
            <h2 class="section-title__title">Meet Our Academic Global Partners</h2>
        </div><!-- section-title -->
        <div class="row">
                    ...
                    <div class="team-one__item">
                        <div class="team-one__image">
                            <?php if (!empty($value['image'])) { ?>
                                <img src="<?php echo base_url('uploads/expert/'.$value['image']); ?>" alt="" style="width: 290px; height: 290px;">
                            <?php } else { if ($value['gender'] == 'Female') { ?>
                                <img src="<?php echo base_url('assets/all/blankwomen.jpg'); ?>" alt="" style="width: 290px; height: 290px;" >
                            <?php } else { ?>
                                <img src="<?php echo base_url('assets/all/blankmen.jpg'); ?>" alt="" style="width: 290px; height: 290px;" >
                            <?php } } ?>
                        </div>
                        <div class="team-one__content">
                            <h3 class="team-one__title">
                              <a href="#"></a>  <?php echo ucwords(strtolower($value['name'])); ?></a>
                            </h3>
                            <span class="team-one__designation"><?php echo ucwords(strtolower($value['designation'])); ?></span>
                        </div>
                    </div>
                </div>
            <?php } ?>            
