...
<section class="page-header @@extraClassName" data-jarallax data-speed="0.3" data-imgPosition="50% -100%">
    ...
    <div class="container text-center">
        <h2 class="page-header__title">Talk to WBJRS Experts Here!!!</h2><!-- /.page-title -->
        <ul class="page-header__breadcrumb list-unstyled">
            <li><a href="<?php echo base_url()?>">Home</a></li>
            <li><span>Welcome Form</span></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 wow fadeInUp animated">
                        <div class="become-team__content">
                            ...
                            <h3 class="become-team__title">Welcome Form</h3>
                    ...
                    <!-- <div class="col-lg-12 wow fadeInUp animated" data-wow-delay="400ms"> -->
                        <div class="become-team__form-box">
                            <h3 class="become-team__form-box__title">Write to Us about your Queries</h3>
                           
                           
                           <div id="popupform" style="display:single;">
                                  ...
                                  <!---  <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="contact-one__input-box text-message-box">
                                            <label class="mylabel">Queries here : <span class="text-danger">*</span> </label>
                                            <textarea name="address" placeholder="Tell us how may we assist you in your career path ?" required=""></textarea>
                                        </div>
                                    </div>
