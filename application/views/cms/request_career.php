                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($value['status'] == 'Pending') { ?>
                                                    <a href="<?php echo base_url($this->setting['cms'].'request_career_mark/'.$id); ?>" class="btn btn-xs btn-danger" > Read </a>
                                                <?php } ?>

                                                <a href="<?php echo base_url($this->setting['cms'].'request_career_delete/'.$id); ?>" class="btn btn-sm btn-danger" title="Delete" onclick="return confirm('Are you sure to delete it?');" > <i class="fa fa-trash"></i> Delete </a>
                                            </td>                                           
                                            <!-- <td > 
